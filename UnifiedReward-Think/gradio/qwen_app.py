...
def _run_model(images, prompt):
    ...
    text_outputs = processor.batch_decode(generated_ids_trimmed, skip_special_tokens=True)[0]
...
def infer(task_type, media1, media2, prompt, R1=None, R2=None):
    ...
    if task_type == "image_generation":
        ...
        question = ("Given a question and a reference image, please analyze in detail the two provided answers (Answer 1 and Answer 2). " \
